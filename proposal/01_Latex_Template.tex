...
\begin{figure}[ht!]
	...
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=.9\textwidth]{files/results/otsu.png}
		\caption{Extracted craters}\label{otsu}
	\end{subfigure}
...
\begin{figure}[ht!]
	...
	\end{subfigure}
	\begin{subfigure}[b]{.45\linewidth}
		\includegraphics[width=.9\textwidth]{files/results/sauvola.png}
		\caption{Extracted craters}\label{sauvola}
	\end{subfigure}
...
\begin{figure}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_niblack.png}
...
\begin{figure}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill	
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_mean.png}\hfill
...
\begin{figure*}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_mean.png}
...
\begin{figure}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill	
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_yen.png}\hfill
...
\begin{figure}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill	
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_li.png}\hfill
...
\begin{figure}[ht!]
	\includegraphics[width=.3\textwidth]{files/results/22.png}\hfill	
	\includegraphics[width=.3\textwidth]{files/results/22_predict.png}\hfill
	\includegraphics[width=.3\textwidth]{files/results/22_isodata.png}\hfill
...
\subsection{Calibration of Lunar Chronology Function}
...
This method will be used to evaluate the pixel-wise detection of craters detected through the algorithm.
