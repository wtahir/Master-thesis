...
\begin{figure}[H]
	...
	\caption{Otsu thresholding. Right image is the thresholded image of the prediction result. Left is the actual input image.}
...
\begin{figure}[H]
	...
	\caption{Adaptive mean thresholding.}
