...
In the past detection of craters from few meters to kilometer sized diameters has been performed with many techniques which are mainly rule based. In recent years deep learning methods have outperformed previous techniques in object detection. However, the focus largely remained on digital elevation maps to avoid complexion of shadows and back A deep learning architecture is proposed in this thesis for crater detection which is able to detect meter sized craters. 
\end{abstract}
