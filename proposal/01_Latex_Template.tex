...
Neukum proposed an analytical function describing the cumulative SFD of maria and oriental basin. He wrote a series of publications in description of his function. For summaries, see \cite{neukum1994crater} and \cite{neukum1983meteoritenbombardement}. On the basis of age assumption NPF was fit to the crater count. It is notable that both HPF and NPF are a good match for the crater diameter (D) data under 1km range. However, with D $>$ 1km, HPF is much higher than HPF and both functions meet together at diameters of approx. 40km
