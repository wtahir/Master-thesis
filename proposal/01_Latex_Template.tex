...
By applying CLAHE the detection of craters increased up to 50\%. 
...
\subsection{Adaptive Mean Thresholding}
...
\subsection{Isodata Thresholding}
...
\begin{figure}[ht!]
	...
	\begin{subfigure}[b]{.4\linewidth}
		\includegraphics[width=.9\textwidth]{files/results/22.png}
		\caption{Crater image}\label{img}
	\end{subfigure}
	
	\begin{subfigure}[b]{.4\linewidth}
		\includegraphics[width=.9\textwidth]{files/results/22_predict.png}
		\setcounter{subfigure}{0}%
		\caption{Crater prediction}\label{pred}
	\end{subfigure}
	\begin{subfigure}[b]{.4\linewidth}
		\includegraphics[width=.9\textwidth]{files/results/crater.png}
		\caption{Extracted craters}\label{ext}
	\end{subfigure}
	\caption{Model output of crater predictions}
	\label{results}
\end{figure}

\begin{figure*}[ht!]
	\includegraphics[width=.4\textwidth]{files/results/gt_binary.png}
	\hfil
	\includegraphics[width=.4\textwidth]{files/results/diff.png}
	\caption{The image on left is ground truth of Figure \ref{results} (a) and on right is the comparison of  Figure \ref{results} (b) with ground truth image. Red circles are extracted craters after post-processing and blue ones are the missed ones.}
	
	\label{clahe}
\end{figure*}

\begin{figure*}[ht!]
	\includegraphics[width=.9\textwidth]{files/results/enhanced_clahe_99_twice_clahe.jpg}
	\caption{Projection of extracted craters on the test image.}
	
	\label{moon}
\end{figure*}

\section{Results}
Hough transformation does a reasonable job of detecting some of large-sized or medium craters but overall performance is quite bad compared to SVM and CSTM \cite{wetzler2005learning}

\subsection{Intersection Over Union (IoU)}
IoU is one of the methods used here to evaluate pixelwise accuracy of the model output. 
...
\begin{table}[ht]
	...
	\begin{tabular}{l|l|l|l|l|l|l|l|l|l|l|l|}
		...
		\multicolumn{1}{|l|}{Otsu}              & 41.7  & 42.9  & 42.6  & 41.2  & 42.3  & 41.2 & 39.8 & 39.1 & 36.9 & 35.5 & 34.5 \\ \hline
		\multicolumn{1}{|l|}{Yen}               & 26.7  & 28.7  & 31.3  & 34.3  & 35.1  & 35.8 & 35.3 & 37.5 & 38.1 & 38.9 & 39.1 \\ \hline
		\multicolumn{1}{|l|}{Li}                & 26.7  & 28.7  & 34.2  & 34.3  & 35.1  & 35.7 & 35.8 & 38.0 & 38.1 & 39.1 & 39.0 \\ \hline
		\multicolumn{1}{|l|}{Mean}              & 22.5  & 25.2  & 26.1  & 26.8  & 28.8  & 30.1 & 32.6 & 34.4 & 34.6 & 36.0 & 35.8 \\ \hline
		\multicolumn{1}{|l|}{Isodata}           & 37.9  & 38.9  & 37.3  & 37.9  & 38.0  & 36.2 & 36.6 & 36.7 & 33.7 & 33.4 & 32.8 \\ \hline
...
\begin{table}[ht!]
		\centering
	\caption{IoU on test data set}
	\begin{tabular}{l|c|c|c|l|}
		\cline{2-5}
		& Otsu & Isodata & Li   & Yen  \\ \hline
		\multicolumn{1}{|c|}{IoU} & 53.6 & 52.5    & 45.6 & 41.6 \\ \hline
	\end{tabular}
\end{table}
